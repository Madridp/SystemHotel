...
@section('main-content')
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">{{ __('Registro de Nuevos Productos') }}</h1>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                     <div class="col-12 text-right">
                                            <a href="{{ route('servicio.index') }}" class="btn btn-md btn-primary">{{ __('Registrar Nuevo Producto') }}</a>
                                        </div>
                                    </div>
