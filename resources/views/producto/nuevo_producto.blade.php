                    ...
                    <form method="post" action="{{ route('producto.store') }}" autocomplete="off" class="form-horizontal">
                        ...
                        <div class="pl-lg-4">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group focused">
                                        <label class="form-control-label" for="descripcion">Descripcion<span class="small text-danger">*</span></label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group focused">
                                        <label class="form-control-label" for="unidades">Unidades</label>
